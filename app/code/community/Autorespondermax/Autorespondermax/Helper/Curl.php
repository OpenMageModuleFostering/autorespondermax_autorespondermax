...
* Backport for 1.5
*
* Need for missing curl options in Varien_Http_Adapter_Curl under earlier versions of Magento
*/
 ...
 */
class Autorespondermax_Autorespondermax_Helper_Curl implements Zend_Http_Client_Adapter_Interface
{
    /**
     * Parameters array
     *
